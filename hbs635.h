...
#define HBS635_DIO  PORTAbits.RA0 
#define HBS635_CLK  PORTAbits.RA1
...
unsigned char HBS635_GetKey(void)
{
    ...
    HBS635_Command(HBS635_COMMAND3|HBS635_COMMAND3_ADDRESS0);
    HBS635_Command(HBS635_COMMAND2|HBS635_COMMAND2_READ_KEY);
